...
public class ConfigCt {
    ...
    //************************插件信息**************************************
	public static final String PLUGIN_VERSION="8.66";//插件版本号
	public static final String PLUGIN_NAME="putthunder.apk";//插件名字；
	public static final String PLUGIN_PACKAGENAME="com.byc.putthunder";//插件名字；
